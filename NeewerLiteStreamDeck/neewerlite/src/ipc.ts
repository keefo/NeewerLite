...
interface ListLightsResponse { lights: Light[]; }
interface PingResponse {  status: string; }
interface SwitchResponse { success: boolean; switched: string[]; }
...
export function toggleLights(lights: string[], state: boolean): Promise<HttpResponse<SwitchResponse>> {
  ...
  return httpPostJson<{ lights: string[]; state: boolean }, SwitchResponse>("/switch", { "lights": lights, "state": state });
}
...
export function setLightsBrightness(lights: string[], brightness: number): Promise<HttpResponse<SwitchResponse>> {
  ...
  return httpPostJson<{ lights: string[]; brightness: number }, SwitchResponse>("/brightness", { "lights": lights, "brightness": brightness });
}
...
export function setLightsTemperature(lights: string[], temperature: number): Promise<HttpResponse<SwitchResponse>> {
  ...
  return httpPostJson<{ lights: string[]; temperature: number }, SwitchResponse>("/temperature", { "lights": lights, "temperature": temperature });
}
...
export function setLightsSAT(lights: string[], sat: number): Promise<HttpResponse<SwitchResponse>> {
  ...
  return httpPostJson<{ lights: string[]; saturation: number }, SwitchResponse>("/sat", { "lights": lights, "saturation": sat });
}
...
export function setLightsFX(lights: string[], fx9: number, fx17: number): Promise<HttpResponse<SwitchResponse>> {
  ...
  return httpPostJson<{ lights: string[]; fx9: number; fx17: number }, SwitchResponse>("/fx", { "lights": lights, "fx9": fx9, "fx17": fx17 });
}

export function setLightsCCT(lights: string[], brightness: number, temperature: number): Promise<HttpResponse<SwitchResponse>> {
  brightness = Number(brightness)
  temperature = Number(temperature)
  streamDeck.logger.trace("setLightsBrightness target lights:", lights, "brightness:", brightness, "temperature:", temperature);
  return httpPostJson<{ lights: string[]; brightness: number, temperature: number }, SwitchResponse>("/cct", { "lights": lights, "brightness": brightness, "temperature": temperature });
}

export function setLightsHST(lights: string[], brightness: number, saturation: number, hex_color: string): Promise<HttpResponse<SwitchResponse>> {
  brightness = Number(brightness)
  saturation = Number(saturation)
  streamDeck.logger.info("setLightsHST target lights:", lights, "brightness:", brightness, "saturation", saturation, "hex_color", hex_color);
  return httpPostJson<{ lights: string[]; brightness: number, saturation: number, hex_color: string }, SwitchResponse>("/hst", { "lights": lights, "brightness": brightness, "saturation": saturation, "hex_color": hex_color });
}
