...
final class CommandPatternParserTests: XCTestCase {
    ...
    static let fx17Patterns: [NamedPattern] = [
        NamedPattern(id: 1, name: "Lighting", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x01 {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: "bolt.fill", image: nil, category: nil, color: nil),
        NamedPattern(id: 2, name: "Paparazzi", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x02 {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: "camera.shutter.button", image: nil, category: nil, color: nil),
        NamedPattern(id: 3, name: "Defective bulb", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x03 {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: "lightbulb.min.badge.exclamationmark.fill", image: nil, category: nil, color: nil),
        NamedPattern(id: 4, name: "Explosion", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x04 {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {sparks:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: "timelapse", image: nil, category: nil, color: nil),
        NamedPattern(id: 5, name: "Welding", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x05 {brr:uint8:range(0,100)} {brr2:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 6, name: "CCT flash", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x06 {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 7, name: "HUE flash", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x07 {brr:uint8:range(0,100)} {hue:uint16_le:range(0,360)} {sat:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 8, name: "CCT pulse", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x08 {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 9, name: "HUE pulse", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x09 {brr:uint8:range(0,100)} {hue:uint16_le:range(0,360)} {sat:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 10, name: "Cop Car", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x0A {brr:uint8:range(0,100)} {color:uint8:range(0,4)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: ["Red", "Blue", "Red and Blue", "White and Blue", "Red blue white"]),
        NamedPattern(id: 11, name: "Candlelight", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x0B {brr:uint8:range(0,100)} {brr2:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {sparks:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 12, name: "HUE Loop", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x0C {brr:uint8:range(0,100)} {hue:uint16_le:range(0,360)} {hue2:uint16_le:range(0,360)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 13, name: "CCT Loop", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x0D {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {cct2:uint8:range(29,70)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 14, name: "INT loop", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x0E {brr:uint8:range(0,100)} {brr2:uint8:range(0,100)} {hue:uint16_le:range(0,360)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: nil, image: nil, category: nil, color: nil),
        NamedPattern(id: 15, name: "TV Screen", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x0F {brr:uint8:range(0,100)} {cct:uint8:range(29,70)} {gm:uint8:range(0,100)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: "tv", image: nil, category: nil, color: nil),
        NamedPattern(id: 16, name: "Firework", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x10 {brr:uint8:range(0,100)} {color:uint8:range(0,2)} {speed:uint8:range(1,10)} {sparks:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: "fireworks", image: nil, category: nil, color: ["Single color", "Color", "Combined"]),
        NamedPattern(id: 17, name: "Party", cmd: "{cmdtag} {fxdatatag} {size} {mac} {fxsubtag} 0x11 {brr:uint8:range(0,100)} {color:uint8:range(0,2)} {speed:uint8:range(1,10)} {checksum}", defaultCmd: nil, icon: "party.popper.fill", image: nil, category: nil, color: ["Single color", "Color", "Combined"]),
    ]
