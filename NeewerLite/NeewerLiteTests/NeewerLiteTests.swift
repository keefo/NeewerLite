...
class NeewerLiteTests: XCTestCase {
    ...
    func test_LightName() throws {
        ...
        XCTAssertEqual(NeewerLightConstant.getLightType(nickName: name.nickName, str: "", projectName: name.projectName), 34, "")
        ...
        XCTAssertEqual(NeewerLightConstant.getLightType(nickName: name.nickName, str: "", projectName: name.projectName), 24, "")
